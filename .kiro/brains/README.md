...
| alfred-cloud | high | architecture, security, ci-cd | pre-write, post-shell, stop |
| alfred-sre | high | debugging, ci-cd, architecture | post-shell, stop |
| alfred-frontend | high | coding, security | pre-write, post-shell, stop |
